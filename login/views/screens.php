      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="screens.php">Screens</a></li>
            <li><a href="pages.php">Pages</a></li>
          </ul>
        </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">

          <h2 class="sub-header">Screens | <a href="new_screen.php">New screen</a></h2>
          </form>
          ...
          <form action="classes/delete_screen.php" method="post">
Delete screen: <input type="text" name="id">
<input type="submit">
</form>
