          ...
          <div class="table-responsive">
            <table class="table table-striped">
              ...
              <tbody>
                <tr>
                  <td>Screens</td>
                  <td><a href="screens.php">show screens</a></td>
                  <td><a href="new_screen.php">new screen</a></td>
                </tr>
                <tr>
                  <td>Pages</td>
                  <td><a href="pages.php">show pages</a></td>
                  <td><a href="new_page.php">new page</a></td>
                </tr>
              </tbody>
            </table>
          </div>
